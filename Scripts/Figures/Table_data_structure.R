...
my_tibble <- d %>%
  mutate(Description = case_when(
    ...
    Variable == "Interaction" ~ "Number of interactions between a plant and a pollinator. Since the rows are ungrouped, each row represents a single interaction.",
    ...
    Variable == "Plant_rank" ~ "The taxonomic rank of the observation is specified at various levels, including species, genus, family, or order.",
